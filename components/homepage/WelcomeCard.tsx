    ...
    <>
      ...
      >
          ...
          <div className="flex justify-center">
            <a href="/syllabus" className="text-indigo-700 hover:text-white bg-white hover:bg-indigo-600 focus:text-white focus:bg-indigo-600 px-6 py-3 rounded-lg font-bold text-lg shadow-md transition-colors">
