        ...
        <div className="main-bg-light min-h-screen pt-16 pb-24 flex flex-col items-center gap-16 ah-font">
            ...
            <div className="max-w-4xl mx-auto px-4 py-10 pt-10 sm:pt-14 md:pt-16 text-lg">
                ...
                <section className="mb-16">
                    ...
                    <h3 className='text-lg sm:text-xl md:text-2xl font-bold mb-2'>Assignment A: You used AI</h3>
                    ...
                    <h3 className='text-lg sm:text-xl md:text-2xl font-bold mb-2'>Assignment B: You did NOT AI</h3>
