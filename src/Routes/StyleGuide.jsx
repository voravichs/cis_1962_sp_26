...
function StyleGuide() {
    useEffect(() => {
        document.title = "Style Guide | CIS 1962";
    }, []);
    return (
        <div className="main-bg-light min-h-screen pt-16 pb-24 flex flex-col items-center gap-16 ah-font">
            ...
            <div className="max-w-4xl mx-auto px-4 py-10 pt-10 sm:pt-14 md:pt-16 text-lg">
                ...
                <section className="mb-16">
                    ...
                    <ul className="list-disc ml-6 text-gray-900 mb-4 text-lg">
                        <li>
                            <span className="font-semibold">Prefer <code>const</code> for variables that never change.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>prefer-const</code>)</span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>no-var</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Do not declare variables that are unused.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>no-unused-vars</code>)</span>
                        </li>
                    </ul>
                ...
                <section className="mb-16">
                    ...
                    <ul className="list-disc ml-6 text-gray-900 mb-4 text-lg">
                        <li>
                            ...
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>eqeqeq</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Combine if/else blocks to avoid “lonely” <code>if</code> statements.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>no-lonely-if</code>, <code>unicorn/no-lonely-if</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Prefer ternary operators (<code>? :</code>) over simple if/else assignments when appropriate.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>unicorn/prefer-ternary</code>)</span>
                        </li>
                    </ul>
                    <div className="mb-2">
                        <p className="font-semibold text-xl">❌ Bad</p>
                ...
                <section className="mb-16">
                    ...
                    <ul className="list-disc ml-6 text-gray-900 mb-4 text-lg">
                        <li>
                            ...
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>prefer-arrow-callback</code>)</span>
                        </li>
                        <li>
                            ...
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>prefer-template</code>)</span>
                        </li>
                    </ul>
                    <div className="mb-2">
                        <p className="font-semibold text-xl">❌ Bad</p>
                ...
                <section className="mb-16">
                    ...
                    <ul className="list-disc ml-6 text-gray-900 mb-4 text-lg">
                        <li>
                            ...
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>unicorn/consistent-destructuring</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Always include a descriptive error message in <code>throw new Error()</code>.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>unicorn/error-message</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Avoid disabling ESLint rules without a clear reason.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>unicorn/no-abusive-eslint-disable</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Do not use <code>alert()</code> in application code.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>no-alert</code>)</span>
                        </li>
                        <li>
                            <span className="font-semibold">Keep return behavior consistent inside functions.</span>
                            <span className="ml-1 text-gray-500 text-sm">(ESLint: <code>consistent-return</code>)</span>
                        </li>
                    </ul>
                    <div className="mb-2">
                        <p className="font-semibold text-xl">❌ Bad</p>
